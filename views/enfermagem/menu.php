...
<body style=" font-family: 'Product Sans';
    ...
    <nav>
        ...
        <ul id="menu">
            ...
            <li>
                <a href="buscarPaciente.php?ficha=gineco" class="a" onclick="aparecer()">
                    <t id="t">Ficha Ginecológica</t>
                </a>

            </li>
            <li>
                <a class="a" href="buscarPaciente.php?ficha=gestante">
                    <t id="t">Ficha da Gestante</t>
                </a>

            </li>
            
            <li>
                <a class="a" href="paciente.php">
                    <t id="t">Cadastrar paciente</t>
                </a>
            </li>
            <li>
