    ...
    src: url('FONTES/PRODUCT SANS');">
        ...
        <form action="">
            <div class="tab-content">
                ...
                <h3 style="color: #409ace"><b>Dados do Cliente</b></h3>

                    <div class="row">
                        <div class="col col-sm-2">
                            <label for="" id="label">Número do prontuário</label>
                            <input type="number" name="numProntuario" class="form-control" required value="">
                        </div>
                        <div class="col col-sm-10">
                             <label for="" id="label">Nome do Cliente</label>
                            <input type="text" name="NomeCliente" class="form-control" required value="">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col col-sm-3">
                            ...
                            <input input type="radio" id="" name="id1" value="">
                            <label for="Feminino">Feminino</label>
                            <input type="radio" id="" name="id1" value="">
                            <label for="Masculino">Masculino</label></div>
                         
                         <div class="col col-lg-3">
                         <label for="">Etnia:</label>
                            <input input type="radio" id="" name="id2" value="">
                            <label for="Branco">Branco(a)</label>
                            <input type="radio" id="" name="id2" value="">
                            <label for="Pardo">Pardo(a)</label><br>
                            <input type="radio" id="" name="id2" value="">
                            <label for="Preto">Preto(a)</label>   
                            <input type="radio" id="" name="id2" value="">
                            <label for="Indigena">Índigena</label>
                            <input type="radio" id="" name="id2" value="">
                            <label for="Amarelo">Amarelo(a)</label></div>
               
                        <div class="col col-sm-3">
                             <label for="" id="label">Data de Nascimento</label>
                            <input type="date" name="" class="form-control" required value="">
                        </div>
                        <div class="col col-sm-3">
                            <label for="" id="label">Idade:</label>
                            <input type="text" name="idade" class="form-control"size="13" maxlength="50"  value=" anos"/>
                        </div>
                                                    </div><br>
                         ...
                         <div class="row">
                             ...
                             <label for="" id="label">Religião</label>
                             <input type="text" name="religiao" class="form-control" required value=""></div>

                             <div class="col col-sm-4">
                             <label for="" id="label">ACS</label>
                             <input type="text" name="acs" class="form-control" required value=""></div>

                             <div class="col col-sm-4">
                             <label for="" id="label">Profissão</label>
                             <input type="text" name="profissao" class="form-control" required value=""></div>
                ...
                <div class="col col-sm-6">
                 ...
                 <div class="col-sm-6">
                    ...
                    <select name="raca" class="form-control" required autocomplete="off">
                        ...
                        <h3 style="color: #409ace"><b>Endereço</b></h3>
                            <div class="row">
                             <div class="col col-sm-3">
                             <label for="" id="label">Cidade</label>
                             <input type="text" name="cidade" class="form-control" required value=""></div>

                             <div class="col col-sm-3">
                             <label for="" id="label">Bairro</label>
                             <input type="text" name="bairro" class="form-control" required value=""></div>

                             <div class="col col-sm-3">
                             <label for="" id="label">Logradouro</label>
                             <input type="text" name="logradouro" class="form-control" required value=""></div>

                             <div class="col col-sm-3">
                             <label for="" id="label">Número</label>
                             <input type="text" name="numeroCasa" class="form-control" required value=""></div>
                         </div><br>

                        <h3 style="color: #409ace"><b>Filiação</b></h3>

                        <div class="row">
                             <div class="col col-sm-6">
                             <label for="" id="label">Nome da mãe</label>
                             <input type="text" name="NomeMae" class="form-control" required value="">
                            </div>
                             <div class="col col-sm-6">
                             <label for="" id="label">Nome do pai</label>
                             <input type="text" name="NomePai" class="form-control" required value="">
                        </div></div>

                        <br>
                        <a href="menu.php" class="btn btn-default" >Voltar a tela inicial</a><br><br>
                </div>
                ...
                <div id="menu1" class="tab-pane fade"><br>
                    <div class="form-group">
                        ...
                        <div class="row">
                             ...
                             <input type="text" name="pressaoArterial" class="form-control" id="pressaoArterial" size="13" maxlength="50"  value=" mmHg"/></div>

                             <div class="col col-sm-6">
                             <label for="" id="label">Glicemia</label>
                             <input type="text" name="glicemia" class="form-control" id="glicemia" size="13" maxlength="50"  value=" mg/dl"/>
                         </div></div><br>
                          ...
                          <div class="row">
                             ...
                             <input type="text" name="SPO" class="form-control" id="spo" size="13" maxlength="50"  value="%"/></div>

                              <div class="col col-sm-6">
                             <label for="" id="label">Pulso</label>
                             <input type="text" name="Pulso" class="form-control" id="pulso" size="13" maxlength="50"  value=" bpm"/></div>
                         </div><br>
                          ...
                          <div class="row">
                             ...
                             <input type="text" name="R" class="form-control" id="r" size="13" maxlength="50"  value="irpm"/></div>

                              <div class="col col-sm-6">
                             <label for="" id="label">Altura</label>
                             <input type="text" name="Altura" class="form-control" id="altura" size="13" maxlength="50"  value=" cm"/></div>
                         </div><br>
                          ...
                          <div class="row">
                             ...
                             <input type="text" name="Peso" class="form-control" id="peso" size="13" maxlength="50"  value="Kg"/></div>

                              <div class="col col-sm-6">
                             <label for="" id="label">Circunferência abdominal</label>
                             <input type="text" name="circAbdominal" class="form-control" id="circabdominal" size="13" maxlength="50"  value=" cm"/></div>
                         </div><br>
                        ...
                        <br>
                        <a href="menu.html" class="btn btn-default">Voltar a tela inicial</a><br><br>
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            <div class="col col-sm-12">
                                ...
                                <input type="radio" id="" name="id5" value="">
                                ...
                                <input type="radio" id="" name="id5" value="">
                                <label for="irmao">Irmã(o)</label>
                                <input type="radio" id="" name="id5" value="">
                                <label for="AvoHomem">Avô</label>
                                <input type="radio" id="" name="id5" value="">
                                <label for="AvoMulher">Avó</label></div>
                        </div><br>
                     ...
                     <div class="row">
                        ...
                        <div class="col col-sm-12">
                         <label for="">Sintomas</label><br>
                            <input type="radio" id="" name="id19" value="">
                            <label for="cianose">Cianose</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="dor">Dor</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="sudorese">Sudorese</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="malestar">Mal estar / fraqueza</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="febre">Febre</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="dispineia">Dispineia</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="nausea">Náusea / Vômitos</label>
                            <input type="radio" id="" name="id19" value="">
                            <label for="nao">Palidez cutânea</label><br></div></div><br>
                            <div class="row">
                ...
                <h3 style="color: #409ace"><b>Oxigenação</b></h3>
                   ...
                   <div class="row">
                    ...
                    <a href="menu.html" class="btn btn-default" target="iframes">Voltar a tela inicial</a><br></div>
